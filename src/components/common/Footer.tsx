      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 pb-12 border-b border-primary-dark">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-6">
              Centro de estudos católicos dedicado à formação espiritual e
              intelectual, seguindo os ensinamentos da Igreja e o exemplo do
              Cardeal Leme.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link
                  to="/"
                  className="text-gray-300 hover:text-secondary transition-colors flex items-center"
                >
                  <svg
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                <svg
                  className="w-5 h-5 text-secondary mt-1 mr-3"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <li className="flex items-center">
                ...
                <a
                  href="mailto:contato@uniaoapostolica.com"
                  className="text-gray-300 hover:text-secondary transition-colors"
                >
          ...
          <div>
            ...
            <div className="mt-8">
              <Link
                to="/contato"
                className="inline-flex items-center bg-secondary text-white px-5 py-2 font-medium hover:bg-opacity-90 transition-colors duration-300"
              >
                <svg
                  className="w-4 h-4 mr-2"
                  fill="none"
        ...
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © {new Date().getFullYear()} União Apostólica Cardeal Leme. Todos os
            direitos reservados.
          </p>
