...
const events: Event[] = [
  {
    ...
    date: '2023-06-12',
    location: 'Casa de Retiros São José, Rio de Janeiro',
    image: 'https://images.unsplash.com/photo-1601142634808-38923eb7c560?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
    description: 'Um tempo de renovação espiritual e aprofundamento na fé, guiado pelos ensinamentos da Igreja.',
  },
  {
    id: '2',
    title: 'Seminário de Doutrina Social',
    date: '2023-05-25',
    location: 'Centro de Estudos Cardeal Leme, Rio de Janeiro',
    image: 'https://images.unsplash.com/photo-1548625149-fc4a29cf7092?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
    description: 'Aprofundamento nos princípios da Doutrina Social da Igreja e sua aplicação na sociedade contemporânea.',
  },
  {
    id: '3',
    title: 'Encontro de Formação',
    date: '2023-07-15',
    location: 'Paróquia Nossa Senhora da Paz, Rio de Janeiro',
    image: 'https://images.unsplash.com/photo-1601142634808-38923eb7c560?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
    description: 'Formação contínua para membros e interessados nos ensinamentos e na espiritualidade católica.',
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-12">
          <div className="flex justify-center items-center mb-4">
            ...
            <span className="text-secondary uppercase tracking-widest text-sm">Agenda</span>
            <div className="h-px bg-secondary w-12 ml-4"></div>
          </div>
          <h2 className="text-3xl md:text-4xl font-serif font-bold text-primary">Próximos Eventos</h2>
