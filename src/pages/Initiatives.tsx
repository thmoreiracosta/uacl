        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <div className="flex justify-center items-center mb-4">
              ...
              <span className="text-secondary uppercase tracking-widest text-sm">O Que Fazemos</span>
            ...
            <p className="text-gray-700 max-w-2xl mx-auto mt-6">
              Nossa missão se concretiza através de diversas iniciativas que buscam
              promover a formação integral da pessoa e a evangelização da cultura.
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className={`${index % 2 !== 0 ? 'order-2' : ''}`}>
                <div className="flex items-center mb-4">
                  <div className="h-px bg-secondary w-12 mr-4"></div>
                  <span className="text-secondary uppercase tracking-widest text-sm">Iniciativa</span>
                </div>
                ...
                {/* Conteúdos específicos por iniciativa podem ser mantidos aqui */}
                {/* ... */}
              </div>
              <div className={`${index % 2 !== 0 ? 'order-1' : ''}`}>
                <div className="relative">
                  <div className={`absolute ${index % 2 === 0 ? '-top-6 -right-6' : '-top-6 -left-6'} w-full h-full border-2 border-secondary`}></div>
