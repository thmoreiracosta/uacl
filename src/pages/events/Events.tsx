...
export const Events: React.FC = () => {
  ...
  useEffect(() => {
    try {
      ...
      setError("Erro ao carregar os eventos locais.");
      ...
      <section className="py-16 bg-primary text-white">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">
            Entre em contato conosco para sugerir temas para futuros eventos ou
            para trazer nossa equipe para sua paróquia ou instituição.
          </p>
          <Link
            to="/contato"
