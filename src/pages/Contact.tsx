        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-200 max-w-3xl mx-auto">
              ...
              ou conversar sobre como você pode participar de nossas atividades.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <div className="flex items-center mb-4">
                ...
                <span className="text-secondary uppercase tracking-widest text-sm">Fale Conosco</span>
              </div>
              ...
              {isSubmitted ? (
                <div className="bg-green-50 border border-green-200 p-6 rounded-md">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-xl font-medium text-green-800">Mensagem Enviada!</h3>
                  </div>
                  <p className="text-green-700 mb-4">
                    Obrigado por entrar em contato conosco. Recebemos sua mensagem e
              ...
              <div className="bg-white p-8 border border-gray-200 h-full">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        contato@cardealleme.org.br<br />
                        secretaria@cardealleme.org.br
                      </p>
                    </div>
                  </div>
                ...
                <div className="mt-8">
                  ...
                  <div className="flex space-x-4">
                    <a href="#" className="w-10 h-10 bg-primary bg-opacity-10 rounded-full flex items-center justify-center hover:bg-opacity-20">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <div className="flex justify-center items-center mb-4">
              <div className="h-px bg-secondary w-12 mr-4"></div>
              <span className="text-secondary uppercase tracking-widest text-sm">Localização</span>
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            <div className="bg-cream p-6 border-t-4 border-primary">
              <h3 className="text-xl font-serif font-bold text-primary mb-3">De Carro</h3>
              <p className="text-gray-700">
            ...
            <div className="bg-cream p-6 border-t-4 border-primary">
              <h3 className="text-xl font-serif font-bold text-primary mb-3">Transporte Público</h3>
              <p className="text-gray-700">
                Metrô: Estação Botafogo (10 minutos a pé).<br />
                Ônibus: Linhas 409, 410, 426, 581 (ponto na esquina).
              </p>
            </div>
            <div className="bg-cream p-6 border-t-4 border-primary">
              <h3 className="text-xl font-serif font-bold text-primary mb-3">Acessibilidade</h3>
              <p className="text-gray-700">
                Nossa sede possui rampas de acesso, elevadores e banheiros adaptados
