...
export const Courses: React.FC = () => {
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-2xl font-serif font-bold text-primary">Formações</h1>
        <p className="text-gray-600">Explore nossas palestras de formação espiritual e intelectual.</p>
      </div>
      ...
      {filteredCourses.length > 0 ? (
        ...
        <div className="text-center py-12 bg-gray-50 border border-gray-200 rounded">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2">Nenhuma formação encontrada</h3>
          <p className="text-gray-500">
            Não encontramos formações com os filtros selecionados.
          </p>
        </div>
      )}
    </div>
